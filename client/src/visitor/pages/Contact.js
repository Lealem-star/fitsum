...
const Contact = () => {
    ...
    return (
        <div className="w-full bg-transparent">
                ...
                <div className="grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12 items-center text-amber-400 p-3 sm:p-4 md:p-6 rounded-xl sm:rounded-2xl border border-white/30 bg-white/10 backdrop-blur-sm">
                    ...
                    <div className="space-y-4 sm:space-y-5 md:space-y-6 order-2">
                        <div className="space-y-3 sm:space-y-4">
                            ...
                            <p className="text-sm sm:text-base md:text-lg font-bold text-black leading-relaxed mt-2 sm:mt-3 md:mt-4">
            ...
            <section className="py-6 sm:py-8 md:py-12 px-3 sm:px-4 md:px-5 mx-2 sm:mx-4 mb-4 sm:mb-6">
                <div className="max-w-5xl mx-auto bg-white/10 backdrop-blur-lg rounded-xl sm:rounded-2xl shadow-2xl border border-white/20 p-4 sm:p-6 md:p-8 text-amber-400">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-center">Follow My Work Updates</h3>
                    <p className="text-xs sm:text-sm text-amber-400/80 mb-4 sm:mb-6 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4">
                        ...
                        <a
                            ...
                            className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-md sm:rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm bg-[#1DA1F2] text-white rounded-md sm:rounded-lg hover:bg-[#1a8cd8] transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                        >
                            <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm bg-[#0077B5] text-white rounded-md sm:rounded-lg hover:bg-[#006399] transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                        >
                            <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm bg-[#1877F2] text-white rounded-md sm:rounded-lg hover:bg-[#166fe5] transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                        >
                            <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm bg-[#FF0000] text-white rounded-md sm:rounded-lg hover:bg-[#cc0000] transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                        >
                            <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Contact Info Cards */}
            <section className="py-6 sm:py-8 md:py-12 px-3 sm:px-4 md:px-5 mx-2 sm:mx-4 mb-6 sm:mb-8 md:mb-12">
                <div className="max-w-6xl mx-auto grid gap-4 sm:gap-6 md:gap-8 md:grid-cols-3 text-amber-400">
                    {/* Physical Address */}
                    <div className="bg-[#111111] rounded-xl sm:rounded-2xl px-4 py-6 sm:px-6 sm:py-8 md:px-8 md:py-10 shadow-2xl border border-white/5 flex flex-col items-center text-center gap-3 sm:gap-4">
                        ...
                        <h3 className="text-base sm:text-lg font-semibold">Physical Address</h3>
                        <div className="text-xs sm:text-sm text-amber-400/80 space-y-1">
                    ...
                    {/* Email Address */}
                    <div className="bg-[#111111] rounded-xl sm:rounded-2xl px-4 py-6 sm:px-6 sm:py-8 md:px-8 md:py-10 shadow-2xl border border-white/10 flex flex-col items-center text-center gap-3 sm:gap-4">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white flex items-center justify-center text-black text-lg sm:text-xl">
                            <span>✉️</span>
                        </div>
                        <h3 className="text-base sm:text-lg font-semibold">Email Address</h3>
                        <div className="text-xs sm:text-sm text-white/80 space-y-1 break-all">
                    ...
                    <div className="bg-[#111111] rounded-xl sm:rounded-2xl px-4 py-6 sm:px-6 sm:py-8 md:px-8 md:py-10 shadow-2xl border border-white/5 flex flex-col items-center text-center gap-3 sm:gap-4">
                        ...
                        <h3 className="text-base sm:text-lg font-semibold">Phone Numbers</h3>
                        <div className="text-xs sm:text-sm text-amber-400/80 space-y-1">
                            <p>+251 972 727 384</p>
                        </div>
                    </div>
